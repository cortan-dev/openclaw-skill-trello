# PR review instructions for this repo

This is the canonical review policy for `openclaw-skill-trello`.
Use it for human review and AI review.
...
Use this structure when reviewing a PR:

### Summary
- one short paragraph on overall safety and readiness

### Blocking issues
- only items that should prevent merge
- for each: issue, why it matters, smallest fix

### Non-blocking improvements
- optional nits, readability, or cleanup suggestions

### Test assessment
- what is covered
- what is missing
- whether tests appear isolated from the network
...
When Spartan reviews a PR for this repo:

1. Read this file first.
2. Inspect the PR diff and changed files.
3. Check CI and tests.
4. Apply the review output format above.
5. Prefer repo-specific guidance from this file over generic review habits.
